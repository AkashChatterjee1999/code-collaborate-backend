...
const initializeCodeCollabService = codeCollabServer => {
    ...
    // const codeCollabServer = new ws.Server({ server: listeningHttpServer, path: "/codeCollab-socket" });
    ...
    let functionalMap = {
        ...
        onClientJoined: (clientID, clientName, profilePic, location, email, streamConstraints) => {
            ++clientCount;
            return {
                "responseEvent": "CLIENT_CONNECTED",
                "responseType": "info",
        ...
        acknowledgeClientInfo: (id, roomID) => {
            ...
            return {
                "responseEvent": "ACKNOWLEDGE_CLIENT_INFO",
                "responseType": "acknowledge",
                "data": {id, roomID, connectedClients}
            }
        }
    }
    ...
    const checkEmailExistedThenReturnId = (email) => {
